        ...
        <div className="basis-full lg:basis-2/6 ">
          ...
          <div className="block">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <button className="flex min-w-[48px] items-center justify-center rounded-full border bg-neutral-100 py-1 px-2 text-base cursor-default ring-2 ring-blue-600">
                Black
              </button>
              <Button name={"White"} />
            </div>
